...
public class ForgotPasswordView extends VerticalLayout {
    ...
    private void onSubmit() {
        ...
        try {
            ...
            Notification.show("Se houver uma conta associada, você receberá um e-mail com instruções para redefinir sua senha.", 5000, Notification.Position.MIDDLE)
                    .addThemeVariants(NotificationVariant.LUMO_SUCCESS);
            email.clear();
        } catch (Exception ex) {
            Notification.show("Erro ao processar solicitação: " + ex.getMessage(), 6000, Notification.Position.MIDDLE)
